  ...
  describe('githubRepo', function() {
    ...
    describe('plugin behavior', function() {
      it('should be available on the jQuery object', function() {
        return expect($.fn.githubRepo).toBeDefined();
      });
      it('should be chainable', function() {
        return expect(this.$element.githubRepo()).toBe(this.$element);
      });
